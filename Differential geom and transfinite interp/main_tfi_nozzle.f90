...
PROGRAM main_tfi_nozzle
		IMPLICIT NONE 

		INTEGER, PARAMETER 		:: M=64, N =100000
		INTEGER					:: i,j,k
		REAL(8), DIMENSION(0:M,0:M) :: X, Y
		REAL(8), DIMENSION(0:M)		:: zeta, eta
		REAL(8), DIMENSION(0:M,2)		:: G1, G2, G3, G4
		REAL(8) 				    :: quar_annulus
		REAL(8)						:: dx=1.d0/M, xmax, xmin, Lx, HL, HR, Ls, dt, ds,h, k1, k2, k3, k4, tl, tr, tm
		REAL(8)						:: area
		! Initialize
		X = 0.d0
		Y = 0.d0
